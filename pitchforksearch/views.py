...
def index():
	...
	if form.validate_on_submit():
		...
		for artist in artists:
			q = build_query(artist, form.score_lower.data, form.score_upper.data, limit)
			q_count = build_query(artist, form.score_lower.data, form.score_upper.data, limit, count_only=True)
...
def build_query(artist, score_lower, score_upper, limit, count_only=False):
	if count_only:
